...
# loading model
weights_path = 'Feature_attribution/segment_0_9/train_model/Seg_AutoEncoder_model.pth'
...
# result_df.to_csv(save_path + '/segment_0_9_AE_features_output.csv', index=False)
...
save_path = 'Feature_attribution/segment_0_9/AE_output'
os.makedirs(save_path, exist_ok=True)
test_sample.to_csv(save_path + '/segment_ae_output_pairs_features.csv', index=False)
