...
from AMPmodel.dataset import load_and_concatenate_pandata, CustomDataset2
...
outputPath = "Model_work/ESM2_AMP_CSE/output"
...
train_data_features = feature_all.loc[:, '1_ESM2_cls0':]
train_data_label = feature_all[['Label']]
...
def train_model(trial):
    ...
    for train_index, val_index in skf.split(train_data_features, train_data_label['Label']):
        ...
        train_dataset = CustomDataset2(X_train, y_train, reshape_shape=(-1, 24, 1280))
        val_dataset = CustomDataset2(X_val, y_val, reshape_shape=(-1, 24, 1280))
