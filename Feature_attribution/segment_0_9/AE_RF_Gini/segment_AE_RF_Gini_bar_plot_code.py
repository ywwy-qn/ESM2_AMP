...
save_path = os.path.join('Feature_attribution/segment_0_9/AE_RF_Gini/output')
...
# Load the model
loaded_best_classifier = load('Feature_attribution/segment_0_9/train_model/seg_best_rf_model.pkl')
...
importance_df.to_csv(save_path + '/segment_AE_RF_Gini_value.csv', index=False)
...
plt.savefig(save_path + '/segment_AE_RF_Gini_plot.pdf', bbox_inches='tight')
plt.show()