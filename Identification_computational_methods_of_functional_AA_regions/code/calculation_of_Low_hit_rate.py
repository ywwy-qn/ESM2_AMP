...
Low_list = [
    f'Identification_computational_methods_of_functional_AA_regions/database_{kuuu}_out/0-0/0-0_Low3_out.xlsx',
    f'Identification_computational_methods_of_functional_AA_regions/database_{kuuu}_out/0-1/0-1_Low3_out.xlsx',
    f'Identification_computational_methods_of_functional_AA_regions/database_{kuuu}_out/1-0/1-0_Low3_out.xlsx',
    f'Identification_computational_methods_of_functional_AA_regions/database_{kuuu}_out/1-1/1-1_Low3_out.xlsx',
]
