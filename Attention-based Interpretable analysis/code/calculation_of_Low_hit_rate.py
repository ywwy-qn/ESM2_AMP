...
kuuu = "interpro"
Low_list = [
    fr'E:\Working\Team\Sun_Yaven\Artcle_topic\文章修改\高注意力片段与特殊片段覆盖信息\database_{kuuu}_out\0-0\0-0_Low3_information.xlsx',
    fr'E:\Working\Team\Sun_Yaven\Artcle_topic\文章修改\高注意力片段与特殊片段覆盖信息\database_{kuuu}_out\0-1\0-1_Low3_information.xlsx',
    fr'E:\Working\Team\Sun_Yaven\Artcle_topic\文章修改\高注意力片段与特殊片段覆盖信息\database_{kuuu}_out\1-0\1-0_Low3_information.xlsx',
    fr'E:\Working\Team\Sun_Yaven\Artcle_topic\文章修改\高注意力片段与特殊片段覆盖信息\database_{kuuu}_out\1-1\1-1_Low3_information.xlsx',
]

# 读取Excel文件
for path in Low_list:
