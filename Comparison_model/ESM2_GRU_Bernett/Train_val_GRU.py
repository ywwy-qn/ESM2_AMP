...
def train_model(trial):
    ...
    save_trail_path = f"Comparison_model/ESM2_GRU_Bernett/weights_file/trial_{trial.number}_bestcheckpoint"
    ...
    best_mcc = sorted_metrics_df.iloc[0][eval_metrics]  # 最优 MCC 值        
...
study.optimize(lambda trial: train_model(trial), n_trials=25, n_jobs=1)
