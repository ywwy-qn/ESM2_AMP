...
save_trail_path = f"Comparison_model/ESM2_AMPS_Bernett/weights_file/bestcheckpoint"



lr = 2.729298775599142e-05
weight_decay = 1.7727403052411835e-05
hidden1_dim = 501
hidden2_dim = 87
...
optimizer = AdamW(model.parameters(), lr=lr, weight_decay=weight_decay)
scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.2, patience=3, verbose=True, min_lr=1e-6)
save_path = 'Comparison_model/ESM2_AMPS_Bernett'
saver = SaveMetricsAndBestCheckpoints(file_name="test_metrics.xlsx", checkpoint_dir=save_path, top_k=3, metrics_name=eval_metrics)
