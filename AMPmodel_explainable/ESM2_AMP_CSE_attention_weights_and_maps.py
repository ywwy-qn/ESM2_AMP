...
save_path = os.path.join('attention_weights/ESM2_AMP_CSE')
os.makedirs(save_path, exist_ok=True)


np.save(save_path + '/ESM2_AMP_CSE_merged_test_atten_average_layers0.npy', merged_test0)
np.save(save_path + '/ESM2_AMP_CSE_merged_test_atten_average_layers1.npy', merged_test1)
np.save(save_path + '/ESM2_AMP_CSE_merged_test_atten_average_layers2.npy', merged_test2)
np.save(save_path + '/ESM2_AMP_CSE_merged_test_atten_average_layers3.npy', merged_test3)
np.save(save_path + '/ESM2_AMP_CSE_merged_test_atten_average_layers4.npy', merged_test4)
np.save(save_path + '/ESM2_AMP_CSE_merged_test_atten_average_layers5.npy', merged_test5)
...
# Attention_visualization_diagram(merged_test0, 0, label_name, 'ESM2_AMP_CSE')

# Attention_visualization_diagram(merged_test1, 1, label_name, 'ESM2_AMP_CSE')
# Attention_visualization_diagram(merged_test2, 2, label_name, 'ESM2_AMP_CSE')

# Attention_visualization_diagram(merged_test3, 3, label_name, 'ESM2_AMP_CSE')
# Attention_visualization_diagram(merged_test4, 4, label_name, 'ESM2_AMP_CSE')
# Attention_visualization_diagram(merged_test5, 5, label_name, 'ESM2_AMP_CSE')
